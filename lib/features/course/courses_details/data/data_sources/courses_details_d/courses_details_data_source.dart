...
class CoursesDetailsWithServer extends CoursesDetailsDataSource{
  ...
  @override
  Future<ResponseModel> getCourseDetails({required TeacherModel model}) async=>remoteExecute(
      request: dioConsumer.getRequest(path: EndPoints.getCoursesDetails,queryParams: model.toJson()),
